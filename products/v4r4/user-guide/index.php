	...
	<section class='content_page module white-bg'>
		<div class='grid_layout'>
			...
			<div class='wysiwyg_content'>
				...
				<p>The directory doc contains a few useful documents that include an overview of v4r4’s directory and file structures (v4r4_overview.pdf, this document), a summary of v4r4 (v4r4_summary.pdf, Fukumori et al., 2019), a note about how to reproduce v4r4 results (v4r4_reproduction_howto.pdf Wang, 2019), a set of analysis plots (v4r4_overview_plots.pdf) generated using gcmfaces (see Software below), and a note on analyzing budgets (evaluating_budgets_in_eccov4r3.pdf, Piecuch, 2017). Also included are summary files of all cost functions (costfunction*) and a “standard output file” (STDOUT.0000) that the model creates during its integration with information about the model configuration and useful measures of the model state.</p>
				<div class="grid">
				...
				<h4>4.2 Introduction to Fields</h4>
				...
				<h4>4.3 Monthly Average Model Fields</h4>
