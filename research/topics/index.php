	...
	<section class='content_page'>
			...
			<div class='grid_layout'>
				<div class='grid'>
					<div class="grid-cell flexit">
						<h2 class="content_title"><a href="">What determines Global Mean Sea Surface Temperature</a></h2>
		...
		<section class='gray-bg2'>
			<div class='grid_layout'>
				<div class='grid'>
					<div class="grid-cell flexit">
						<h2 class="content_title">Ice-ocean coupling of the Amundsen Sea</h2>
